resource "azurerm_virtual_network_peering" "from_spoke1-to-hub" {
    ...
    remote_virtual_network_id = azurerm_virtual_network.hub_vnet
...
resource "azurerm_virtual_network_peering" "from-hub-to-spoke1" {
    ...
    remote_virtual_network_id = azurerm_virtual_network.spoke1-vnet
    allow_forwarded_traffic = true
    allow_virtual_network_access = true
    allow_gateway_transit = false
    use_remote_gateways = false
...
resource "azurerm_virtual_network_peering" "From_hub_to_spoke2" { 
    ...
    resource_group_name = azurerm_resource_group.hub_rg
    virtual_network_name = azurerm_virtual_network.hub_vnet
    remote_virtual_network_id = azurerm_virtual_network.spoke2-vnet
    allow_forwarded_traffic = true
    allow_virtual_network_access = true
  allow_gateway_transit = false
  use_remote_gateways = false
...
resource "azurerm_virtual_network_peering" "from_spoke2_to_hub" {
    ...
    resource_group_name = azurerm_resource_group.Prod_rg
    virtual_network_name = azurerm_virtual_network.spoke2-vnet
    remote_virtual_network_id = azurerm_virtual_network.hub_vnet
    allow_forwarded_traffic = true
    allow_virtual_network_access = true
    allow_gateway_transit = false
